...
class Index extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <title>Ryo Suzuki | University of Colorado Boulder Assistant Professor</title>
...
<div className="ui five stackable cards">
  <div className="card">
    <div className="content">
      ...
      <div className="description">
        We redesign "languages", including written, spoken, and visual languages, to empower human-to-human communication
      </div>
      <br/>
...
<div className="ui five stackable cards">
  <div className="card">
    <div className="image">
      <img src="/static/posters/cinemaworld.jpg" />
    </div>
    <div className="content">
      <div className="ui tiny label">UIST 2026</div>
      <div className="header">
        <a href="/cinemaworld" target="_blank">CinemaWorld</a>
      </div>
      <div className="description">Generative AR for Movie Augmentation</div>
    </div>
  </div>

  <div className="card">
    <div className="image">
      <img src="/static/posters/mapstory.jpg" />
    </div>
    <div className="content">
      <div className="ui tiny label">UIST 2025</div>
      <div className="header">
        <a href="/mapstory" target="_blank">MapStory</a>
      </div>
      <div className="description">Editable Map Animations with LLM Agents</div>
    </div>
  </div>

  <div className="card">
    <div className="image">
      <img src="/static/posters/guided-reality.jpg" />
    </div>
    <div className="content">
      <div className="ui tiny label">UIST 2025</div>
      <div className="header">
        <a href="/guided-reality" target="_blank">Guided Reality</a>
      </div>
      <div className="description">Visually-Enriched AR Task Guidance</div>
    </div>
  </div>

  <div className="card">
    <div className="image">
      <img src="/static/posters/realitysummary.jpg" />
    </div>
    <div className="content">
      <div className="ui tiny label">SUI 2025</div>
      <div className="header">
        <a href="/realitysummary" target="_blank">RealitySummary</a>
      </div>
      <div className="description">On-Demand Mixed Reality Summarization</div>
    </div>
  </div>

  <div className="card">
    <div className="image">
      <img src="/static/posters/video2mr.jpg" />
    </div>
    <div className="content">
      <div className="ui tiny label">IUI 2025</div>
      <div className="header">
        <a href="/video2mr" target="_blank">Video2MR</a>
      </div>
      <div className="description">Generating Mixed Reality Instructions from Video</div>
    </div>
  </div>
            ...
            <section className="container">
              ...
              <div id="posters">
                ...
                <div className="ui vertical segment">
                  ...
                  { posters.map((item) => {
                      return (
                        <div className="project ui vertical segment stackable grid" data-id="" key={item.id}>
                          <div className="six wide column">
                            <a href={ `/phd-thesis` }>
                          ...
                          <div className="ten wide column">
                            ...
                            <div className="item" target="_blank" style={{ lineHeight: '1.8rem' }}>
                              <a href={ '/static/publications/' + item.pdf }><b>{ item.title }</b></a>
                              <br />
                              { item.author }.
                              <br/>
                              { item.pdf && <a href={ '/static/publications/' + item.pdf } target="_blank" style={{ marginRight: '5px' }}>[PDF]</a> }
                              { item.poster && <a href={ '/static/publications/' + item.poster } target="_blank" style={{ marginRight: '5px' }}>[Poster]</a> }
                              { item.slide && <a href={ '/static/publications/' + item.slide } target="_blank" style={{ marginRight: '5px' }}>[Slide]</a> }
              ...
              <div id="press">
                ...
                <div className="ui vertical segment">
                  <div className="ui bulleted list">
                    { press.map((item) => {
                      return (
                        <div className="item" key={`${item.date}-${item.media}-${item.title}`}>
