    ...
    return (
      <header className="ui stackable grid">
        <div className="ui sixteen wide column">
          ...
          <video id="top-video" poster="/static/posters/top.jpg" preload="metadata" autoPlay loop muted playsInline webkit-playsinline="">
            {/*
          ...
          <div id="profile" style={{ fontSize: '1.3rem' }}>
            ...
            <p>
              My research lies at the intersection of <b>Human-Computer Interaction (HCI)</b>, <b>AR/VR</b>, <b>tangible interfaces</b>, and <b>AI</b>. I direct the <b><a href="https://www.colorado.edu/atlas/programmable-reality-lab" target="_blank">Programmable Reality Lab</a></b> at CU Boulder, where we build computational media that blend digital and physical worlds.
            </p>
            {/* Recruiting paused; retain this block for future reuse.
            <div className="ui segment" style={{ borderColor: '#191970' }}>
            ...
            */}
            ...
            <div class="ui segment" style={{ borderColor: '#2ECC40' }}>
              ...
              <p>
                ...
                &nbsp;&nbsp;&nbsp;
                <a className="ui inverted green button" href="/static/cv/cv.pdf" target="_blank" style={{ marginTop: '20px'}}><b>
                  <i className="far fa-file-pdf fa-fw" />
                  Resume/CV
                </b></a>
              </p>
          ...
          <div className="ui horizontal list" style={{ marginTop: '20px' }}>
            ...
            <div className="item">
              <a href="/static/cv/cv.pdf" target="_blank" style={{ fontSize: '1.2em' }}>
