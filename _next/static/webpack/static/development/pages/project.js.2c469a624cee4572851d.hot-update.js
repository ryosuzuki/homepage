...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Project, [{
    ...
    value: function render() {
      ...
      }, project.name)), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("h1", {
        className: "title"
      }, project.title), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("p", null, project.authors.map(function (author) {
        return author === 'Ryo Suzuki' ? react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("strong", null, author) : react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("span", null, author);
      }).reduce(function (prev, curr) {
        return [prev, ', ', curr];
      })), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("p", null, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("a", {
        href: project.conference.url
      }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("b", null, project.conference.fullname))), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("p", null, "Links: [", react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("a", {
        herf: project.pdf
      }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("b", null, "PDF")), "] [", react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("a", {
        herf: project.doi
      }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("b", null, "DOI")), "]"), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(react_markdown__WEBPACK_IMPORTED_MODULE_8___default.a, {
      ...
      })), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("h1", null, "Publication"), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
        class: "ui placeholder segment"
      }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("p", null, project.authors.join(', ').replace(/, ([^,]*)$/, ', and $1').map(function (author) {
        return author === 'Ryo Suzuki' ? react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("strong", null, author) : react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("span", null, author);
      }).reduce(function (prev, curr) {
        return [prev, ', ', curr];
      }), "Ryo Suzuki, Junichi Yamaoka, Daniel Leithinger, Tom Yeh, Mark D. Gross, Yoshihiro Kawahara, and Yasuaki Kakehi. 2018. ", react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("b", null, "Dynablock: Dynamic 3D Printing for Instant and Reconstructable Shape Formation"), ". ", react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("i", null, "In Proceedings of the 31st Annual ACM Symposium on User Interface Software and Technology (UIST '18)"), ". ACM, New York, NY, USA, 99-111.", react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("br", null), "DOI: ", react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("a", {
        href: "https://doi.org/10.1145/3242587.3242659",
        target: "_blank"
      }, "https://doi.org/10.1145/3242587.3242659"))), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("p", null, project.publication)), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
        className: "one wide column"
...
//# sourceMappingURL=project.js.2c469a624cee4572851d.hot-update.js.map